...
class User {
  ...
  User({
    ...
    this.phoneNumber = '', // 👈 TAMBAHKAN INI dengan default value
    required this.level,
  ...
  factory User.fromJson(Map<String, dynamic> json) {
    return User(
      ...
      phoneNumber: json['phoneNumber'] ?? '', // 👈 TAMBAHKAN INI
      level: json['level'] ?? 1,
  ...
  User copyWith({
    ...
    return User(
      ...
      phoneNumber: phoneNumber ?? this.phoneNumber, // 👈 TAMBAHKAN INI
  ...
  @override
  String toString() {
    return 'User(id: $id, name: $name, email: $email, phoneNumber: $phoneNumber, level: $level, points: $points)';
  }
